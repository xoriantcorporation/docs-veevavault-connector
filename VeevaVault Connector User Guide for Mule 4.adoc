...
____
image:media/user-guide/image1.png[image,width=531,height=386]
____
...
[loweralpha]
. In Anypoint Studio, click the Exchange icon image:media/user-guide/image2.png[image,width=19,height=18] in the taskbar.
...
[loweralpha, start=3]
. Enter *Veeva Vault* in the search box and hit Enter.
...
When Studio has an update, a message displays in the lower right corner, which you can click to install the update.[#_heading=h.30j0zll .anchor]##
...
[arabic]
. Drag and drop any of connector operation to the Studio Canvas.
. Click on icon image:media/user-guide/image3.png[image,width=21,height=21] of Connector configuration to create global element for the connector configurations.

image:media/user-guide/image4.png[image,width=601,height=54]
...
image:media/user-guide/image5.png[image,width=579,height=183]
...
image:media/user-guide/image6.png[image,width=557,height=126]
...
The Daily API limit exceed profile configuration *(Connector Configuration > Advanced Tab)* to act upon if Daily API limit of Veeva Vault API is exceeded or reach threshold configured. The Daily limit is the total number of API calls within any 24-hour window on a daily rolling basis.

By default, this option is enabled. If the Daily API Limit Exceed Profile is enabled, then connector will evaluate Veeva APIs response header *(X-VaultAPI-DailyLimitRemaining)* value with API Limit threshold specified value, the connector will throw an exception indicating the Daily API Limit is exceeded, the exception will continue for each and every job/request created until daily limit is reset or roll over the next day.
...
image:media/user-guide/image7.png[image,width=560,height=80]
...
The maximum time in milliseconds that the connector will wait for the Veeva Vault response. If time elapsed will throw Timeout Exception. By default, is 10,000 milliseconds.

image:media/user-guide/image8.png[image,width=558,height=31]
...
* {blank}
* {blank}
* link:\l[Delete Documents]
* {blank}
* link:\l[Update Documents]
* {blank}
* link:\l[Download Document]
* {blank}

link:\l[Export Documents]

*Document Renditions*

* {blank}
* {blank}
* link:\l[Create Document Renditions]
* {blank}
* link:\l[Get Document Renditions]
* {blank}

link:\l[Delete Document Renditions]

*Vault Objects*

* {blank}
* {blank}
* link:\l[Create Object Records]
* {blank}
* link:\l[Get Object Records]
* {blank}
* link:\l[Delete Object Records]
* {blank}

link:\l[Update Object Records]
...
Follow the instructions mentioned in link:#_heading=h.30j0zll[Connector Configuration]

*Operation Configuration:*

image:media/user-guide/image9.png[image,width=601,height=90]
...
|Input a|
You can find the following list of document metadata required to create document(s) on vault. Make sure payload should have mandatory metadata as per vault.

image:media/user-guide/image10.png[image,width=283,height=326]

|Output a|
You can find create documents operation output status or response from vault.

image:media/user-guide/image11.png[image,width=297,height=201]
...
Note – The output of the operation would be in pagination mechanism, please refer to link:#_heading=h.1y810tw[Streaming and Pagination] for more details.
...
image:media/user-guide/image12.png[image,width=601,height=356]

[cols=",",]
|===
|Fields |Description
|Type (Optional) |Click on icon image:media/user-guide/image13.png[image,width=22,height=22] to retrieve Document Types from vault. Select a document type from the list to retrieve document properties.
|Subtype (Optional) |Click on icon image:media/user-guide/image13.png[image,width=22,height=22] to retrieve Document Subtypes from vault. Select a document subtype from the list to retrieve document properties.
|Classification (Optional) |Click on icon image:media/user-guide/image13.png[image,width=22,height=22] to retrieve Document Classification from vault. Select a document classification from the list to retrieve document properties.
...
image:media/user-guide/image14.png[image,width=288,height=313]
...
image:media/user-guide/image15.png[image,width=601,height=90]
...
|Input a|
You can find the following list of document metadata required to delete document(s) on vault.

image:media/user-guide/image16.png[image,width=301,height=55]

|Output a|
You can find delete documents operation output status or response from vault.

image:media/user-guide/image17.png[image,width=300,height=147]
...
image:media/user-guide/image18.png[image,width=601,height=95]
...
|Input a|
You can find the following list of editable document metadata to update document(s) on vault. Make sure payload should have only editable metadata as per vault.

image:media/user-guide/image19.png[image,width=286,height=343]

|Output a|
You can find create documents operation output status or response from vault.

image:media/user-guide/image20.png[image,width=303,height=148]
...
Follow the instructions mentioned in link:#_heading=h.30j0zll[[.underline]#Connector Configuration#]

*Operation Configuration:*

image:media/user-guide/image21.png[image,width=536,height=160]
...
image:media/user-guide/image22.png[image,width=588,height=216]
...
|Input a|
You can find the following input document metadata required to export document(s) from vault to FTP staging server. Make sure payload should have mandatory metadata as per vault.
...
|Document Metadata |Document Metadata payload with required metadata either in CSV or JSON format. Make sure payload would be in format as specified in Metadata format field.
|Input a|
You can find the following list of document metadata required in payload under Input tab of operation.
...
|===
|Field Fields |Description
|Object Name |Click on icon image:media/user-guide/image13.png[image,width=22,height=22] to retrieve vault object list. Select the object name from the list to create records for selected object.
...
|Input a|
You can find the following list of object metadata required to create object records.
...
image:media/user-guide/image34.png[image,width=290,height=147]

|===

==== Get Object Records

The Get Object Records operation allows to retrieve object records detail using object metadata fields to build a VQL query dynamically and execute on vault to get Object details. Place For-Each/Splitter element after this Operation to fetch each object record (page) sequentially.
...
image:media/user-guide/image35.png[image,width=601,height=297]

[cols=",",]
|===
|Fields |Description
|Vault Object |Click on icon image:media/user-guide/image13.png[image,width=22,height=22] to retrieve vault objects list from vault. Select an object from the list to retrieve object records detail.
...
|===
|Field Fields |Description
|Object Name |Click on icon image:media/user-guide/image13.png[image,width=22,height=22] to retrieve vault object list. Select the object name from the list to delete object records for selected object.
|Metadata Format |Select CSV or JSON option to accept document metadata in specified format.
|Object Metadata |Object fields payload with required metadata either in CSV or JSON format. Make sure payload would be in format as specified in Metadata format field.
|Input a|
You can find the following list of object metadata required to delete object records.
...
|===
|Field Fields |Description
|Object Name |Click on icon image:media/user-guide/image13.png[image,width=22,height=22] to retrieve vault object list. Select the object name from the list to update object records of vault object.
|Metadata Format |Select CSV or JSON option to accept object metadata in specified format.
|Object Metadata |Object fields payload with required metadata either in CSV or JSON format. Make sure payload would be in format as specified in Metadata format field.
|Input a|
...
[#_heading=h.o3gezwa2666a .anchor]##
...
|Field |Description
|VQL Query a|
Enter https://developer.veevavault.com/vql/#introduction-to-vault-queries[[.underline]#VQL#] query to send it to Vault.

*Note -- Do not specify LIMIT and OFFSET in VQL query.*

|Input Parameters a|
The input parameters are to pass parameter(s) to VQL query dynamically. The parameters should be name-value pairs, payload or variables value can be passed. Eg.
...
In the above example, the input parameters are supplied as key-value pairs, which you can create by embedding a DataWeave script. Those keys are used in conjunction with the semicolon character *(:)* to reference a parameter value by name. This is the recommended approach for using parameters in your VQL query.
...
|===
|Field |Description
|Picklist Name (Optional) |Click on icon image:media/user-guide/image13.png[image,width=22,height=22] to retrieve picklists from vault. Select a picklist name from the list to retrieve picklist values.
|Input |N/A
|Output a|
...
image:media/user-guide/image45.png[image,width=601,height=168]

[cols=",",]
|===
|Field |Description
|Audit Type |Click on icon image:media/user-guide/image13.png[image,width=22,height=22] to retrieve audit types from vault. Select an audit type from the list whose audit details need to retrieve.
...
* link:#_heading=h.o3gezwa2666a[Query]
* link:#get-audit-details[Get Audit Details]

While using these above paginated operations make sure to place For-Each/Splitter to retrieve each object (metadata in JSON format) at a time. The pagination operations have fields – *Fetch Size and Batch Size.*

* *Fetch Size:* The Fetch Size is a limit number of records that can be retrieved in a page. The operation would return the pages with fetch size number of JSON object records. Note, in some cases, Veeva API’s auto-calculate fetch size (number of records on each page) based on record size accumulated exceed the standard record size. The operation will return calculated records on each page.
* *Batch Size:* The Batch Size is the number of pages it would return in each batch and each page will have fetch size number of records. The operation would return number of records (metadata in JSON format) per batch is calculated as below, *e.g*.:
...
In non-repeatable stream connector operation would returns stream as number of records per batch and in repeatable stream would returns all records in one, so when calculating the in-memory buffer size for repeatable auto-paging, you need to estimate how much memory space each instance takes to avoid running out of memory.
...
|Get Document Renditions |Get Document Renditions operation retrieves renditions details of particular document. | |link:#_heading=h.3as4poj[Get Document Renditions]
...
* You must know about the basic concept of Veeva Vault.
...
image:media/user-guide/image48.png[image,width=601,height=193]

image:media/user-guide/image49.png[image,width=587,height=137]
...
* Configure transformation using Dataweave as per your business needs.
...
image:media/user-guide/image50.png[image,width=601,height=246]
...
image:media/user-guide/image51.png[image,width=582,height=255]
...
image:media/user-guide/image53.png[image,width=471,height=248]
...
image:media/user-guide/image54.png[image,width=483,height=254]
