...
|*Spark Validator* |Spark Validator operation validates and verify Spark message trigger from vault using public key and signature retrieved. | |link:#spark-validator-example[Spark Validator]
|===
