...
*link:\l[Export Documents]Document Renditions*

* {blank}
* link:\l[*Create Document Renditions*]
* link:\l[*Get Document Renditions*]

*link:\l[Delete Document Renditions]Vault Objects*
...
*link:\l[Update Object Records]VQL Query*

* {blank}

*link:\l[Query]Picklists*

* {blank}

*link:\l[Get Picklists]Audit*
...
The document type, subtype and classification are optional, if none are selected then document properties metadata are fetched using API (/api/\{version}/metadata/objects/documents/properties) and VQL Query is built and executed.
