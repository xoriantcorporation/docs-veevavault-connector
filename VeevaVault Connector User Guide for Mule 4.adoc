...
The Veeva Vault Connector can be use in the Mule application as an outbound connector with CRUD (Create, Retrieve, Update, Delete), Query, operations on following Vault Objects. These operations are discussed later in this document.
...
* {blank}
* *link:\l[Delete Documents]link:#update-documents[Update Documents]*
* {blank}

*link:\l[Export Documents]Document Renditions*

* {blank}
* *link:\l[Create Document Renditions]link:#get-document-renditions-types[Get Document Renditions Types]*
* {blank}
