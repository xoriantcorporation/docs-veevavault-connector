...
+
image:media/image2.png[image,width=531,height=386]

[arabic, start=4]
. *Install the Connector from https://docs.mulesoft.com/exchange/[Anypoint Exchange].*

[loweralpha]
. In Anypoint Studio, click the Exchange icon image:media/image3.png[image,width=19,height=18] in the taskbar.
...
. *Click on icon* image:media/image4.png[image,width=21,height=21]**of Connector configuration to create global element for the connector configurations.**
+
image:media/image5.png[image,width=601,height=54]
. *Set these fields:*

*Username Password Authentication:*

image:media/image6.png[image,width=561,height=169]
...
image:media/image7.png[image,width=557,height=126]
...
image:media/image8.png[image,width=560,height=80]
...
image:media/image9.png[image,width=558,height=31]
...
image:media/image10.png[image,width=601,height=90]
...
|Input |You can find following list of document metadata required in payload under Input tab of operation.
|Output |You can find following operation output or response under Output tab.
|===
...
|Metadata Format |Select CSV or JSON option to accept document metadata in specified format.
|Document Metadata |Document Metadata payload with required metadata either in CSV or JSON format. Make sure payload would be in format as specified in Metadata format field.
|Input |You can find following list of document metadata required to create document(s) on vault. Make sure payload should have mandatory metadata as per vault.
|Output |You can find create documents operation output status or response from vault.
|===
...
image:media/image15.png[image,width=601,height=112]
...
|Input |You can find following list of object metadata required to create object records.
|Output |You can find operation output or response retrieved from vault for an object records created.
|===
...
image:media/image19.png[image,width=601,height=90]
...
|Input |You can find following list of document metadata required to create document(s) on vault. Make sure payload should have mandatory metadata as per vault.
|Output |You can find delete document renditions operation output status or response from vault.
|===
...
|Metadata Format |Select CSV or JSON option to accept document metadata in specified format.
|Document Metadata |Document Metadata payload with required metadata either in CSV or JSON format.
|Input |You can find following list of document metadata required to delete document(s) on vault.
|Output |You can find delete documents operation output status or response from vault.
|===
...
|Metadata Format |Select CSV or JSON option to accept document metadata in specified format.
|Object Metadata |Object fields payload with required metadata either in CSV or JSON format. Make sure payload would be in format as specified in Metadata format field.
|Input |You can find following list of object metadata required to delete object records.
|Output |You can find operation output or response retrieved from vault for an object records deleted.
|===
...
image:media/image26.png[image,width=536,height=160]
...
image:media/image27.png[image,width=601,height=221]
...
|Input |You can find following input document metadata required to export document(s) from vault to FTP staging server. Make sure payload should have mandatory metadata as per vault.
|Output |You can find export documents job status response under output tab.
|===
...
image:media/image30.png[image,width=601,height=168]
...
|Input |N/A
|Output |The following selected audit type details retrieved from vault in pagination format. Make sure to use For each / Splitter to fetch each record.
|===
...
image:media/image32.png[image,width=601,height=61]

[cols=",",options="header",]
|===
|Field |Description
|Document Metadata |Document Id in payload either in CSV or JSON format.
|Input |You can see document Id required in payload under Input tab of operation to retrieve document renditions details
|Output |You can find following operation output or response under Output tab.
|===
...
image:media/image35.png[image,width=601,height=356]
...
|Batch Size |Provide number of pages per batch. Default is 10.
|Input |N/A
|Output |You can find list of queryable document properties retrieved from vault. If document properties list is provided, then specified properties detail would retrieve and result in operation output. Default would be list of all queryable properties.
|===
...
image:media/image37.png[image,width=601,height=297]
...
|Batch Size |Provide number of pages per batch. Default is 10.
|Input |N/A
|Output |You can find the list of object records fields to refer to add into Object fields list. If object fields list is provided, then specified fields detail comes as output. Default would be list of all fields.
|===
...
image:media/image39.png[image,width=601,height=60]
...
|Input |N/A
|Output |You can find picklist values with name and label as an output of Get Picklists operation.
|===
...
image:media/image41.png[image,width=601,height=286]
...
|Batch Size |Provide number of pages per batch. Default is 10.
|Input |N/A
|Output |You can find the specified VQL query fields in output tab of operation. It returns specified VQL query result contains pagination data.
|===
...
image:media/image43.png[image,width=601,height=95]
...
|Input |You can find following list of editable document metadata to update document(s) on vault. Make sure payload should have only editable metadata as per vault.
|Output |You can find create documents operation output status or response from vault.
|===
...
|Object Metadata |Object fields payload with required metadata either in CSV or JSON format. Make sure payload would be in format as specified in Metadata format field.
|Input |You can find following list of object metadata required to create object records.
|Output |You can find object status of an object updated as an output or response retrieved from vault under output tab of operation.
|===
...
* You mush know about Veeva VQL query (https://developer.veevavault.com/vql/#introduction-to-vault-queries)
...
image:media/image47.png[image,width=469,height=246]
...
image:media/image48.png[image,width=601,height=193]

image:media/image49.png[image,width=578,height=135]
...
image:media/image50.png[image,width=601,height=222]
...
image:media/image51.png[image,width=481,height=256]
...
image:media/image52.png[image,width=482,height=256]
...
image:media/image53.png[image,width=582,height=255]
...
image:media/image54.png[image,width=598,height=245]
...
image:media/image55.png[image,width=601,height=244]
...
image:media/image56.png[image,width=601,height=252]
...
image:media/image57.png[image,width=601,height=242]
